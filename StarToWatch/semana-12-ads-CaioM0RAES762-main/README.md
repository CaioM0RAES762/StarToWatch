[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=19631975)
...
- Breve descrição sobre seu projeto: Desenvolvi um site de filmes dinâmico, com interface moderna e funcionalidades interativas. O site conta com um carrossel de destaques, barra de pesquisa para localizar filmes, cabeçalho fixo e menu de navegação principal no topo. A aplicação permite navegação entre páginas e integração com uma API local via JSON Server, oferecendo uma experiência mais completa ao usuário.
...
![alt text](<prints/Post db.png>)

<<  COLOQUE A IMAGEM PUT AQUI >>
![alt text](prints/Put.png)

<<  COLOQUE A IMAGEM DELETE AQUI >>
![alt text](prints/delete.png)
![alt text](<prints/delete db.png>)

**Print da aba NETWORK com requisições Fetch/XHR de POST**
![alt text](<prints/requisição Fetch/XHR POST.png>)
